...
namespace CourseDaoApplication
{
    public class CourseDAO : ICourseDAO
    {
        ...
        IEnumerable<Course> ICourseDAO.GetAllCourses()
        {
            throw new NotImplementedException();
        }

        Course ICourseDAO.GetCourse(int id)
        {
            throw new NotImplementedException();
        }
        ...
        void ICourseDAO.DeleteCourse(int id)
        {
            throw new NotImplementedException();
        }

        object ICourseDAO.FindCourseById(int id)
        {
            throw new NotImplementedException();
        }

        public object FindStudentCourseByStudentEmail(string studentEmail)
        {
            throw new NotImplementedException();
        }

        public object FindProfessorCourseByName(string professorName)
        {
            throw new NotImplementedException();
        }
    }
